...
namespace DC.DCEditor
{
    ...
    internal class HealthInspector : Editor
    {
        ...
        private void DrawHealthIndicatorHeader()
        {
            ...
            //Head
            EditorGUILayout.LabelField("Current Health: " + health.HealthValue.ToString("0.00"), headerStyle);

            EditorGUILayout.Space();

            //Health Bar
            Rect lineRect = GUILayoutUtility.GetRect(18f, 10f);
            EditorGUI.ProgressBar(lineRect, health.HealthValue / health.MaxValue, "");
